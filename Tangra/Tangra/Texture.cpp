...
Texture::Texture(std::wstring& a_FilePath, GraphicsCommandList& a_CommandList)
{
...

    {
        ...
        device->CreateCommittedResource(&heapProperties, D3D12_HEAP_FLAG_NONE, &bufferDesc, D3D12_RESOURCE_STATE_GENERIC_READ, nullptr, IID_PPV_ARGS(&m_DefaultBuffer));
    }
   ...
   /* D3D12_SHADER_RESOURCE_VIEW_DESC desc;
    ...
    desc.Shader4ComponentMapping = D3D12_SHADER_COMPONENT_MAPPING_FORCE_VALUE_0;
